...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-10 bg-white p-10 rounded-2xl shadow-sm">
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-500">
              Create your account and start building the next generation of products
            </p>
          </div>
        </div>
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                } rounded-lg placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#0F533A] focus:border-transparent transition-all duration-200 sm:text-sm`}
          ...
          <div>
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-[#0F533A] hover:bg-[#0a3f2c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0F533A] transition-colors duration-200"
            >
              {isLoading ? (
