        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
              <div className="p-6 flex-grow flex flex-col">
                ...
                <p className="text-gray-600 mb-6 flex-grow">
                  Get started with one project and basic AI features to experience the platform.
                </p>
                <button
              ...
              <div className="bg-gray-50 px-6 py-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600">Feature limitations apply</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-gray-300 mt-0.5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                    </svg>
                    <span className="text-sm text-gray-400">No integrations</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
              <div className="p-6 flex-grow flex flex-col">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-bold text-gray-900">One Project</h2>
                </div>
                <div className="mb-4">
                ...
                <p className="text-gray-600 mb-6 flex-grow">
                  Perfect for founders who need to define a single product <span className="bg-[#F0FDF4] px-1.5 py-0.5 rounded text-[#0F533A] font-medium">without a subscription</span>.
                </p>
              ...
              <div className="bg-gray-50 px-6 py-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600">Unlimited exports</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-[#f59e0b] mt-0.5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                    <span className="text-sm text-gray-600">AI requests for 30 days only</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="bg-[#0F533A]/5 px-6 py-4">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm text-gray-600">All export formats</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="py-4 px-6 text-center text-sm text-gray-500">Basic</td>
                    <td className="py-4 px-6 text-center text-sm font-medium text-[#0F533A] bg-[#0F533A]/5">All formats</td>
                    <td className="py-4 px-6 text-center text-sm text-gray-500">All formats</td>
                  </tr>
                  <tr>
