      ...
      <div className="container mx-auto px-4 py-6 flex-grow flex flex-col">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col space-y-3 md:hidden mt-4">
            ...
            {limitStatus && projects.length > 0 && (
              <div className="flex items-center justify-between bg-white rounded-lg border border-[#e5e7eb] p-3">
                ...
                {!limitStatus.canCreateProject && (
                  <Link 
                    href="/upgrade" 
                    className="text-sm font-medium text-[#0F533A] hover:text-[#0F533A]/90"
                  >
                    Upgrade for more
                  </Link>
                )}
            ...
            {/* New Project Button - Only show if there are projects */}
            {projects.length > 0 && (
              <Link 
                href="/project/new" 
        ...
        {isLoading ? (
          ...
          <div className="mt-4 bg-white rounded-2xl shadow-sm p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
            <div className="w-10 h-10 bg-[#0F533A]/10 rounded-full flex items-center justify-center mx-auto mb-2">
            ...
            <h2 className="text-xl font-bold text-[#111827] mb-2 text-center">Start building your next great product</h2>
            <p className="text-[#6b7280] mb-4 max-w-xl mx-auto text-center text-sm">Transform your ideas into reality with our streamlined development process.</p>
            
            <div className="grid md:grid-cols-3 gap-3 max-w-4xl mx-auto mb-4">
              {/* Step 1 */}
              <div className="bg-white rounded-xl p-3 shadow-sm border border-[#e5e7eb] hover:border-[#0F533A]/20 hover:shadow-md transition-all">
                <div className="w-8 h-8 bg-[#0F533A]/10 rounded-full flex items-center justify-center mb-2 mx-auto">
                  <svg className="w-4 h-4 text-[#0F533A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-base font-semibold text-[#111827] mb-1 text-center">From Idea to Product</h3>
              ...
              <div className="bg-white rounded-xl p-3 shadow-sm border border-[#e5e7eb] hover:border-[#0F533A]/20 hover:shadow-md transition-all">
                ...
                <h3 className="text-base font-semibold text-[#111827] mb-1 text-center">Documentation</h3>
              ...
              <div className="bg-white rounded-xl p-3 shadow-sm border border-[#e5e7eb] hover:border-[#0F533A]/20 hover:shadow-md transition-all">
                ...
                <h3 className="text-base font-semibold text-[#111827] mb-1 text-center">Start Building</h3>
                <p className="text-[#6b7280] text-center text-sm mb-2">Export your documentation and start building in your favorite development environment.</p>
                
                <div className="flex flex-col items-center space-y-2">
                  {/* Development Environments */}
                  <div className="flex items-center justify-center space-x-4">
                    <div className="group flex flex-col items-center transition-all">
                      <img src="/cursor.jpg" alt="Cursor" className="h-6 w-auto rounded-md opacity-90 group-hover:opacity-100 transition-opacity" />
                    </div>
                    <div className="group flex flex-col items-center transition-all">
                      <img src="/replit.png" alt="Replit" className="h-6 w-auto rounded-md opacity-90 group-hover:opacity-100 transition-opacity" />
                    </div>
                    <div className="group flex flex-col items-center transition-all">
                      <img src="/lovable.jpeg" alt="Lovable" className="h-6 w-auto rounded-md opacity-90 group-hover:opacity-100 transition-opacity" />
                    </div>
                  </div>
            ...
            <Link
              href="/project/new"
                className="inline-flex items-center justify-center px-4 py-2 rounded-lg font-medium bg-[#0F533A] text-white hover:bg-[#0a3f2c] transition-all duration-200 shadow-sm group text-sm"
            >
